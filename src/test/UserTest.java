...
import cn.li.service.RoleService;
...
public class UserTest {
    ...
    public void findRolesTest() {
        List<Role> setUser = userService.findRoles("li");
    ...
    public void findPermissionsTest() {
        List<Permission> setUser = userService.findPermissions("li");
        System.out.println(setUser);
    }
